...
<div class="main-sidebar">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="nav-item dropdown <?= ($current_url == 'staff') ? 'active' : ''; ?>">
      ...
      <li class="nav-item dropdown <?= ($current_url == 'client') ? 'active' : ''; ?>">
        <a href="#" class="nav-link has-dropdown"><i class="fas fa-user-tie"></i> <span>Client</span></a>
        <ul class="dropdown-menu">
          <?php if ($user['role_id'] == 1): ?>
            <li><a class="nav-link beep beep-sidebar" href="<?= base_url('client/tambahclient'); ?>">Menambah Client</a>
            </li>
          <?php endif; ?>
          <li><a class="nav-link" href="<?= base_url('client'); ?>">Daftar Client</a></li>
        </ul>
      </li>
      <li class="nav-item dropdown <?= ($current_url == 'portfolio') ? 'active' : ''; ?>">
        <a href="#" class="nav-link has-dropdown"><i class="fas fa-briefcase"></i> <span>Portfolio</span></a>
        <ul class="dropdown-menu">
          <li><a class="nav-link beep beep-sidebar" href="<?= base_url('portfolio/tambah'); ?>">Menambah Portfolio</a>
          </li>
          <li><a class="nav-link" href="<?= base_url('portfolio'); ?>">Daftar Portfolio</a></li>
        </ul>
      </li>
      <li class="menu-header">Berita & Layanan</li>
      <li class="nav-item dropdown <?= ($current_url == 'berita') ? 'active' : ''; ?>">
      ...
      <hr>
      <li class="nav-item">
        <a href="<?= base_url('auth/logout'); ?>" class="nav-link"><i class="fas fa-sign-out-alt"></i>
          <span>Keluar</span></a>
      </li>
    </ul>
  </aside>
